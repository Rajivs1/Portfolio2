...
const HireMe = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm(
      'YOUR_SERVICE_ID', // Create a service on EmailJS and put its ID here
      'YOUR_TEMPLATE_ID', // Create an email template on EmailJS and put its ID here
      form.current,
  ...
  return (
    <div className="min-h-screen py-20 px-4 md:px-8 lg:px-16 bg-background-light dark:bg-background-dark relative overflow-hidden">
      {/* Animated Background */}
